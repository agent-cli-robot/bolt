...
- `pnpm run start`: Previews the built app locally using Vite.
- `pnpm run preview`: Builds the project and then previews it locally with Vite.
...
Deployment steps depend on your hosting provider. Build the app with `pnpm run build` and deploy the generated artifacts as required by your platform.
